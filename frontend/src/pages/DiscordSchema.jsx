...
const TEMPLATES = {
  ...
  'Add Account (Cash)': {
    ...
    action: 'insert',
    entity: 'account',
    data: { id: '__generate__', name: 'My Wallet', type: 'cash', currency: 'BDT' },
  },
  'Add Account (Bank)': {
    event_id: '__generate__',
    action: 'insert',
    entity: 'account',
    data: { id: '__generate__', name: 'My Bank', type: 'bank', currency: 'BDT' },
  },
  'Add Account (bKash)': {
    event_id: '__generate__',
    action: 'insert',
    entity: 'account',
    data: { id: '__generate__', name: 'bKash', type: 'bkash', currency: 'BDT' },
  },
  'Add Account (Nagad)': {
    event_id: '__generate__',
    action: 'insert',
    entity: 'account',
    data: { id: '__generate__', name: 'Nagad', type: 'nagad', currency: 'BDT' },
  },
  'Add Account (Rocket)': {
    event_id: '__generate__',
    action: 'insert',
    entity: 'account',
    data: { id: '__generate__', name: 'Rocket', type: 'rocket', currency: 'BDT' },
  },
  'Update Account': {
    event_id: '__generate__',
    action: 'update',
